...
var arcgis = document.getElementById('arcgis');
//var tditu = document.getElementById('tianditu');
...
/*long.addEventListener('click', function(){
  long.style.border = '1px solid #00B7FF';
  star.style.border = 'none';
  google.style.border = 'none';
  mapbox.style.border = 'none';
  tditu.style.border = 'none';
...
bing.addEventListener('click', function(){
  bing.style.border = '1px solid #00B7FF';
  star.style.border = 'none';
  google.style.border = 'none';
  mapbox.style.border = 'none';
  long.style.border = 'none';
...
here.addEventListener('click', function(){
  here.style.border = '1px solid #00B7FF';
  star.style.border = 'none';
  google.style.border = 'none';
  mapbox.style.border = 'none';
  long.style.border = 'none';
